...
| 경로 | 역할 |
|---|---|
| `proto/*.proto` | Echo, 입장, 방, 채팅, 위치 메시지의 필드와 번호 |
...
protoc --proto_path=common/proto --csharp_out=out/generated/csharp common/proto/echo.proto common/proto/session.proto common/proto/room.proto common/proto/chat.proto common/proto/position.proto common/proto/game.proto
```
...
`game.proto`는 사용자 정의 명령과 알림을 전달합니다. command/event 번호별 payload는 게임이 정의하며 최대 4000바이트입니다. [게임 로직 개발 가이드](../docs/게임_로직_개발_가이드.md)를 참고하세요.
